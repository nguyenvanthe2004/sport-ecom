  ...
  return (
    <footer className="footer">
        ...
        <div className="footer-container">
          ...
          <div className="footer-column">
            ...
            <p className="footer-description">
              Shop thời trang thể thao uy tín, chuyên cung cấp các sản phẩm chất lượng cao với giá cả hợp lý. Cam kết mang đến trải nghiệm mua sắm tốt nhất cho khách hàng.
            </p>
          ...
          <div className="footer-column">
            ...
            <div className="footer-contact">
              ...
              <div className="contact-item">
                ...
                <div>
                  ...
                  <p><a href="tel:0387873303">0387.873.303</a></p>
                </div>
              </div>
              <div className="contact-item">
                ...
                <div>
                  <strong>Email:</strong>
                  <p><a href="mailto:support@webthethao.vn">support@webthethao.vn</a></p>
                </div>
              </div>
              <div className="contact-item">
            ...
            {/* Zalo Button */}
            <a href="https://zalo.me/0387873303" target="_blank" rel="noopener noreferrer" className="zalo-button">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="footer-bottom">
        <div className="footer-container">
          <p>&copy; 2025 WebTheThao.vn - Bản quyền thuộc về WEBTHETHAO</p>
          <p className="footer-credit">Thiết kế bởi <span>WebTheThao Team</span></p>
        </div>
      </div>
    </footer>
  );
